---
name: verify
description: Run verification commands and record exact evidence.
---
...
- Canonical role skill: `.agents/skills/verify/SKILL.md`
...
- .ralph/reports/<run-id>/<spec-key>/verify.md
