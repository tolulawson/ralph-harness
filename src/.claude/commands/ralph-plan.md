...
Do not let the main thread become the planning coordinator. If that subagent cannot be launched natively, stop and report the adapter as unsupported instead of planning inline.
