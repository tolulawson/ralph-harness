...
That orchestrator should fill the admitted-spec execution window with worker subagents up to the bounded thread budget, rather than spawning multiple orchestrators or settling for one-role-at-a-time execution while runnable specs remain.
