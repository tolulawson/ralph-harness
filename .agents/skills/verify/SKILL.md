...
1. Read the required checks from policy, the active task, and the active spec plan.
2. Run the smallest set of commands that prove the outcome.
3. Record exact pass, fail, or blocked evidence.
4. Treat the active PR branch as the verification unit when PR metadata exists.
